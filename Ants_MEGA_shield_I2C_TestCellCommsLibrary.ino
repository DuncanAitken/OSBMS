...
void setup() {
 ...
 // for debugging, press reset on PCB to see via serial what code is running :)
  Serial.println("FILE =->Ants_MEGA_shield_I2C_TestCommsLibrary");
#endif
...
//  lcd.print(cellMeanMillivolt);
    ...
    lcd.print(cells.getCellsMaxV());  
    lcd.setCursor(0, 2);
    lcd.print("Min voltage= ");  
    lcd.print(cells.getCellsMinV());  
    ...
    // TODO: could work out where the fault is
  } // not all cells read
