...
void setup() {
  ...
  lcd.setCursor(0, 2);
  lcd.print("  3rd August 2017   ");   // NB must be 20 characters or it garbles
  lcd.setCursor(0, 3);
...
/************************** Ants's high cell warning !!! *******************************/

if (cellMaxMillivolt >3430) {                          // - overcharge alarm -
      digitalWrite(ALARM_LED_PIN, HIGH);
      delay(20);
      digitalWrite(ALARM_LED_PIN, LOW);
      delay(100);
...
if (cellMaxMillivolt >3450) {                          // - serious overcharge alarm -
      digitalWrite(ALARM_LED_PIN, HIGH);
      delay(300);
      digitalWrite(ALARM_LED_PIN, LOW);
      delay(100);
